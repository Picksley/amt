...
<table class="fuel_cost_table">
  <tr>
    <td class="drk"><p> Indicitive fuel costs</p></td>
		<td class="lgt"><p>£XXX.XX</p></td>
  </tr>
  <tr>
    <td class="drk"><p> Annual fuel costs</p></td>
			<td class="lgt"><p>£XXX.XX</p></td>
  </tr>
  <tr>
    <td class="drk"><p> Monthly fuel costs</p></td>
			<td class="lgt"><p>£XXX.XX</p></td>
  </tr>
  <tr>
    <td class="drk"><p> Weekly fuel costs</p></td>
			<td class="lgt"><p>£XXX.XX</p></td>
  </tr>
...
<button type="submit">get valuation</button>
    ...
    <button type="submit" class="hm_redbtns"> Calculate tax now <img src="images/hmright_arrow.png"> </button></div>
                                    </div>
                            </div><!--col-lg-4-->
