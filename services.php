		...
		<div class="row">
			<div class="col-md-12">
				<div class="services_des">
					<h1>Services</h1>
					<p>We're here to make leasing a car or van as easy and convenient for you as possible. To enhance your leasing deal, we can offer you a wide range of additional bolt-on services, from maintenance packages to vehicle tracking tools and more.</p>

					<div class="show_morbrands"><a href="#car-leasing-services"><button>View the services <i class="fa fa-angle-down" aria-hidden="true"></i></button></a></div>
				</div>
			</div>
		</div>
	</div>
...
<section class="services_amt" id="car-leasing-services">
  <div class="container">
  	<div class="row">
  		...
  		<div class="col-md-6 col-sm-6 col-xs-12 rtl-nopadd pull-right">
  				<img src="images/services_maintenance.png" class="img-responsive" alt="Get the Maintenance Service package">
  		</div>

  		<div class="col-md-6 col-sm-6 col-xs-12 services_benefits">
  				<h2>Maintenance</h2>
          ...
          <a href="maintenance.php"> LEARN ABOUT OUR MAINTENANCE PACKAGES </a>
  		</div>
...
<section class="gap_insurance">
  ...
  <div class="gap_insurance_content">
...
<section class="services_info_extra">
  ...
  <div class="row">
  <!--Start List-->
  <div class="col-md-6 offset-md-2 col-sm-6 col-xs-12 benefit-item rtl-nopadd">
  ...
  <!--Start List-->
  <div class="col-md-6 col-sm-6 col-xs-12 benefit-item no-padd">
  <div class="benefits-list first-l">
