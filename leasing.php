...
<p> We have a number of special offers available every month across a range of vehicles to suit all tastes and budgets. You'll need to hurry though as stock is limited so if you see a vehicle you're interested in, don't delay, give us a call today. </p>
</div>


<?php include('special_offers_include.php'); ?>
