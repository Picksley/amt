  ...
  <div class="row">
	...
	<div class="home_banner_des">
      <div class="page-title">
        <h1>Car or van? Business or personal? This is vehicle leasing made easy.</h1>
        <p class="home-bannertext">Whether you’re new to car leasing or a seasoned professional; if you want to understand the benefits that leasing can provide for your business, or you’re after a new car for personal use, we’re here to find you the best deal on your new vehicle.</p>

		 <p class="mob-bannertext">We're here to find you the best deal on your new vehicle</p>
      </div>
	  </div>
    </div>
...
<div class="row">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Personal</a></li>
...
<section class="hm_takealook">
    ...
    <button type="submit" class="hm_redbtns">Find out more about amt <img src="images/hmright_arrow.png"> </button></div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="hm_takealookdtl">
                                            ...
                                            <div class="hm_takealookcontt">
                                            <h3>Free car valuation service</h3>
    ...
    <button type="submit" class="hm_redbtns">Free car valuation service <img src="images/hmright_arrow.png"> </button></div>
                                    </div>
                            </div><!--col-lg-4-->
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="hm_takealookdtl">
                                            ...
                                            <p>If you want to estimate the benefit in kind tax you could pay for a vehicle, then use our calculator and make an informed choice.
Still in doubt? Then give us a call.
...
<section class="hm_leasprocss">
    <div class="container">
    		<div class="hm_leasprocssinfo">
                    ...
                    <h3>If you’re new to leasing and want to understand how it all works, read on.</h3>
...
<h1>What’s the difference?</h1>
    ...
    <div class="row">
      <div class="twopart what_differ">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 inner_box1">
		<div class="veh_sol">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 inner_box1 noborder">
...
<section class="hm_brandsbg">
    <div class="container">
            ...
            <h2>Our car brands:</h2>
                    ...
                    <h2>Our van brands:</h2>
                    <div class="hm_carbrands hm_vanbrands">
                    <div class="row">
                        		 <div class="col-lg-2 col-md-2  col-sm-2   col-xs-2 hm_brandresize" >
                                	<div class="hm_branddtl">
                                		<a href="#"><div class="hm_brandimg"><img src="images/brands/CITROEN.png"></div>
                                ...
                                <div class="col-lg-2 col-md-2  col-sm-2   col-xs-2 hm_brandresize" >
                                	<div class="hm_branddtl">
                                		<a href="#"><div class="hm_brandimg"><img src="images/brands/DACIA.png"></div>
                                        <div class="hm_brandnam">DACIA <img src="images/hmbrand_arrow.png"></div></a>
                                       </div>
                                </div><!--col-lg-2-->
                                ...
                                <div class="col-lg-2 col-md-2  col-sm-2   col-xs-2 hm_brandresize" >
                                	<div class="hm_branddtl">
                                		<a href="#"><div class="hm_brandimg"><img src="images/brands/fuso.png"></div>
                                        <div class="hm_brandnam">fuso <img src="images/hmbrand_arrow.png"></div></a>
                                       </div>
                                </div><!--col-lg-2-->
                                ...
                                <div class="col-lg-2 col-md-2  col-sm-2   col-xs-2 hm_brandresize" >
                                	<div class="hm_branddtl">
                                		<a href="#"><div class="hm_brandimg"><img src="images/brands/ISUZU.png"></div>
                                        <div class="hm_brandnam">ISUZU <img src="images/hmbrand_arrow.png"></div></a>
                                       </div>
                                </div><!--col-lg-2-->

                                <div class="col-lg-2 col-md-2  col-sm-2   col-xs-2 hm_brandresize" >
                                	<div class="hm_branddtl">
                                		<a href="#"><div class="hm_brandimg"><img src="images/brands/IVECO.png"></div>
                                        <div class="hm_brandnam">IVECO <img src="images/hmbrand_arrow.png"></div></a>
                                       </div>
                                </div><!--col-lg-2-->
                        </div><!--row-->
                    <div class="show_morbrands"><button>Show me more car brands <i class="fa fa-angle-down" aria-hidden="true"></i></button></div>
...
<div class="tc-accordion tc-accordion-style1" id="accordion1">
								...
								<div class="panel">
		                            <h4 class="acdn-title">
		                                <a data-toggle="collapse" data-parent="#accordion1" href="#collapse7">How long is the contract hire or lease period?</a>
		                            </h4>
...
<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 hm-blogcnter">
<div class="hm_blog">
<span class="blog_catlable">Category</span>
<figure>
<div class="blog_overlay"></div>
