    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="about_blok1">
          <article>
            <header>
              <h1>A potted history of AMT Leasing</h1>
              <h2>AMT Leasing was formed back in 1995 by Neil Mcgawley. He saw an opportunity in the leasing market and so struck out on his own to become a one-man leasing and finance broker. </h2>
              <p>Fast forward 22 years and Neil still heads up the AMT group of companies which today are worth £20m and employ over 150 staff across the country. </p>
              <p> Over this time, the business has grown and diversified adding premium and prestige car sales in 2004 through AMT Specialist Cars and a premium and specialist vehicle rental business  AMT Rental - established in 2008. AMT Vehicle Rental has 7 regional branches and a 2000-strong car fleet. What’s next? Well, we’re not content with just ‘ticking over’ we want to continue to grow and diversify the AMT group of companies, exceeding customers’ expectations as we go. </p>
            </header>
          </article>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="makes_stus">
        <h2>What makes our service so good</h2>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="four_service">
          <article>
            <figure><img class="img-responsive" alt="KeenuApps" src="images/icons/dedicated-support.svg" width="60" height="60"> </figure>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="four_service">
          <article>
            <figure><img class="img-responsive" alt="KeenuApps" src="images/icons/flexible-term.svg" width="60" height="60"> </figure>
            <h2>Dedicated support </h2>
            <p>You’ll get a dedicated and experienced account manager to support you throughout the process and beyond.</p>
          </article>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="four_service">
          <article>
            <figure><img class="img-responsive" alt="KeenuApps" src="images/icons/part-exchange.svg" width="60" height="60"> </figure>
            <h2>Dedicated support </h2>
            <p>You’ll get a dedicated and experienced account manager to support you throughout the process and beyond.</p>
          </article>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="four_service">
          <article>
            <figure><img class="img-responsive" alt="KeenuApps" src="images/icons/great-value.svg" width="60" height="60"> </figure>
            <h2>Dedicated support </h2>
            <p>You’ll get a dedicated and experienced account manager to support you throughout the process and beyond.</p>
          </article>
        </div>
...
<section class="Accr_line">
  <div class="container">
    <div class="Accr_inr">
      <section>
        <h1>Accreditation</h1>
        <p>We are accredited by the BVRLA – the UK’s independent vehicle rental and leasing body – so you can be rest assured you’re dealing with reputable and knowledgeable car leasing experts.</p>
      </section>
    </div>
    <div class="row">
