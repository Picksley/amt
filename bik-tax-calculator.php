...
<h1>BIK tax calculator</h1>
<p>A company car can be a valuable perk and choosing one can be a lot of fun. Unfortunately, the potential tax implications are not so much fun and choosing the wrong car can prove to be an expensive mistake. So be in the know - use our BIK tax calculator as a guide to see how much tax you will pay on the vehicle of your choice.</p>
...
<div class="row">
<div class="col-lg-5 col-xs-12 col-sm-5 col-ms-5">
<div class="prd_oursodtl prd_list">
			...
			<!--End main div-->
                ...
                <div class="wht_viewspo"><button type="submit"> add to my showroom</button></div>

			<div class="hm_addmyshrm"><button type="submit"><img src="images/delete.png" alt="">Delete</button></div>
...
<div class="col-lg-7 col-xs-12 col-sm-7 col-ms-7">
...
<table>
  ...
  <tr>
    <td><p>Emissions band</p></td>
  </tr>
  <tr>
    <td><p>P11d price</p></td>
  </tr>
  <tr>
    <td><p class="sm_txt">Tax year</p></td>
  </tr>
  <tr>
    <td><p>BIK rate</p></td>
  </tr>
  <tr class="make_lst">
    <td><p>Monthly tax payable</p></td>
  </tr>
  <tr class="make_lst">
    <td><p>Annual tax payable</p></td>
  </tr>
</table>
</div>
    ...
    <table  class="table-bordered table">
  <tr>
    <td colspan="3"><p><span>A</span>101-110g/km</p></td>
    </tr>
  <tr>
    <td colspan="3"><p>£XXX.XX</p></td>
    </tr>
  <tr>
    <td><p>2017/18</p></td>
    <td><p>2018/19</p></td>
...
<p>To work out the BIK value of a company car, you multiply the car’s P11D price (list price including optional extras, VAT and delivery charges, less the first-year registration fee and annual road tax) by the percentage BIK band the car sits in. The BIK band is determined by the CO2 emissions of the vehicle. <br>
  The actual figure you’ll pay is this number multiplied by your income tax band of 20% or 40%. <br>
</p>
<p>To allow for easy comparison of vehicles by BIK rate, save yourself a headache and use our
BIK rate calculator. </p>
