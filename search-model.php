...
<div class="container">
<div class="col-md-12">
<h1><img src="images/audi_logo.png">Audi A3 leasing deals</h1>
...
<div class="container">
<div class="col-md-12">
<img src="images/audi-car.jpg" class="img-responsive">
         	...
         	<div class="row">
			   ...
			   <div class="adv_dlistimg">
                	...
                	<div class="adv_dlistinam">
                    		<h3>Audi A3 Hatchback</h3>
                            <h5>1.0 TFSI SE 5dr</h5>
        ...
        <!---------------------------------------------------------->
         <div class="adv_dealslistinfo">
         	<div class="row">
               ...
               <div class="col-lg-3 col-md-3 col-sm-3">
			                  	<div class="adv_dlistinam active_blank">
                    		<h3>Audi A3 Hatchback</h3>
                            <h5>1.0 TFSI SE 5dr</h5>
                            <!--<div class="adv_namspofr">Special offer</div>-->
                    </div>
